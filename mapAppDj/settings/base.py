"""
Django settings for mapAppDj project.
...
WSGI_APPLICATION = 'mapAppDj.wsgi.application'
...
CACHES = {
    'default': {
        ...
        'KEY_PREFIX': 'mapAppDj',  # Provide a unique value for intra-app cache
...
MAP_THUMBNAIL_URL = "https://maps.googleapis.com/maps/api/staticmap?center={latitude},{longitude}&zoom={zoom}&size=200x150&maptype={maptype}"
